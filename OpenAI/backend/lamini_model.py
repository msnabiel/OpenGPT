...
def build_prompt(query: str, context: List[str]) -> str:
    ...
    This function builds a prompt for LaMini. It takes the original query,
...
def main(
    ...
    # create embedding function (no changes needed here if you're using Chroma embeddings)
    """embedding_function = embedding_functions.GoogleGenerativeAiEmbeddingFunction(
        api_key=os.getenv("GOOGLE_API_KEY"), task_type="RETRIEVAL_QUERY"
    )"""
    ...
    while True:
        ...
        response = get_lamini_response(query, results["documents"][0])  # type: ignore
